...
export default function YearView({
    ...
    setGoalColorMap(prevMap => {
      ...
      selectedGoals.forEach((goal, index) => {
        ...
        if (prevMap.has(goal)) {
          ...
          // Asignar un color único aleatorio que no está ya usado
  ...
  // Función para asignar tracks (filas) a los eventos basíndose en superposiciones
          ...
          >
            ...
            <View style={styles.monthsBarWithTrash}>
              ...
              {yearEvents.map((event, eventIndex) => {
                ...
                // Asegurar que las líneas no se extiendan más all? de diciembre (100% de los 12 meses)
                // Si la línea se extiende más all? de diciembre, cortarla en el 100%
